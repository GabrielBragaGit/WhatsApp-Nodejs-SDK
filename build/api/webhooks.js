...
export default class WebhooksAPI extends BaseAPI {
    ...
    start(cb) {
        this.server = new HttpsServer(this.config[WAConfigEnum.ListenerPort], (req, res) => {
            ...
            if (req.url) {
                ...
                if (requestPath.pathname ==
                    ...
                    if (req.method === 'GET') {
                        if (requestPath.searchParams.get('hub.mode') == 'subscribe' &&
