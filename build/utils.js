...
const importConfig = (senderNumberId, configToImport) => {
  ...
  const config = {
    ...
    [enums_1.WAConfigEnum.AppId]: configToImport[enums_1.WAConfigEnum.AppId] || process.env.M4D_APP_ID || '',
    ...
    [enums_1.WAConfigEnum.BusinessAcctId]: configToImport[enums_1.WAConfigEnum.BusinessAcctId] || process.env.WA_BUSINESS_ACCOUNT_ID || '',
    [enums_1.WAConfigEnum.APIVersion]: configToImport[enums_1.WAConfigEnum.APIVersion] || process.env.CLOUD_API_VERSION || '',
    [enums_1.WAConfigEnum.AccessToken]: configToImport[enums_1.WAConfigEnum.AccessToken] || process.env.CLOUD_API_ACCESS_TOKEN || '',
